...
__Note:__ for serious experiments, we recommend installing hivemind from github (i.e. not pip) as it can run RemoteMixtureOfExperts faster by an order of magnitude. These changes will only reach PYPI in v0.9.0 release.
